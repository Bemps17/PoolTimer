  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: 'H8timer',
        description:
          'Chronomètre de tir billard / Blackball FFB avec contrôle à distance : télécommande et écran Visuel en miroir.',
        lang: 'fr',
      ...
      workbox: {
        ...
        globIgnores: ['**/version.json', '**/robots.txt', '**/sitemap.xml'],
        navigateFallback: 'index.html',
        navigateFallbackDenylist: [
          /^\/tutorial\//,
          /^\/robots\.txt$/i,
          /^\/sitemap\.xml$/i,
          /\.(?:svg|png|jpg|jpeg|gif|webp|mp3|wav|ico|txt|xml)$/i,
        ],
